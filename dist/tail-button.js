...
function fr() {
  ...
  function j(h, c, T) {
    ...
    if (h && h.defaultProps) for (p in c = h.defaultProps, c) y[p] === void 0 && (y[p] = c[p]);
    ...
    function Te(e, r, t, n, o, u) {
      {
        ...
        if (!i) {
          ...
          d ? a += d : a += he();
          var s;
          e === null ? s = "null" : q(e) ? s = "array" : e !== void 0 && e.$$typeof === P ? (s = "<" + (b(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, f("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var l = Qe(e, r, t, o, u);
        if (l == null)
          return l;
        ...
        if (k.call(r, "key")) {
          var _ = b(e), v = Object.keys(r).filter(function(lr) {
            return lr !== "key";
...
var dr = Z.exports;
function pr({ label: C }) {
  return /* @__PURE__ */ dr.jsx("button", { className: "border bg-blue-400 text-white py-2 px-5 rounded-full", children: C ?? "submit" });
}
export {
  pr as default
};
